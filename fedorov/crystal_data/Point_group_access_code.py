...
# NOTE: this is the code for record that was last used in June 2020 to generate
# all PointGroup info The use of this code is not required to use this package
...
for num in range(1, 33):
    driver.get(
        "https://www.cryst.ehu.es/cgi-bin/cryst/programs/"
...
for key, item in point_group_rotation_matrix_dict.items():
    ...
    for i in range(0, n):
        qtemp = rowan.from_matrix(
            item["rotations"][i, :, :], require_orthogonal=False
        )
